...
contract AcuityAccountItemsTest is DSTest {
    ...
    AcuityAccountItemsProxy mixAccountItemsProxy;
    ...
    function setUp() public {
        ...
        mixAccountItems = new AcuityAccountItems(mixItemStoreRegistry);
        mixAccountItemsProxy = new AcuityAccountItemsProxy(mixAccountItems);
    }
