...
import "../mix-trusted-accounts/AcuityTrustedAccounts.sol";
...
contract AcuityReactionsTest is DSTest {
    ...
    AcuityReactions mixReactions;

    function setUp() public {
        mixItemStoreRegistry = new AcuityItemStoreRegistry();
        mixItemStore = new AcuityItemStoreIpfsSha256(mixItemStoreRegistry);
        mixTrustedAccounts = new AcuityTrustedAccounts();
        mixReactions = new AcuityReactions(mixItemStoreRegistry, mixTrustedAccounts);
    }
    ...
    function testGetTrustedReactions() public {
        bytes32 itemId = mixItemStore.create(bytes2(0x0000), hex"1234");
        AcuityReactionsProxy account0 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account1 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account2 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account3 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account4 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account5 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account6 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account7 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account8 = new AcuityReactionsProxy(mixReactions);
        AcuityReactionsProxy account9 = new AcuityReactionsProxy(mixReactions);
