...
contract AccountProxy {
    ...
    AcuityTokenBurn mixTokenBurn;
    AcuityItemStoreIpfsSha256 mixItemStore;

    constructor (AcuityTokenInterface _token0, AcuityTokenInterface _token1, AcuityTokenInterface _token2, AcuityTokenInterface _token3, AcuityTokenBurn _mixTokenBurn, AcuityItemStoreIpfsSha256 _mixItemStore) public {
        token0 = _token0;
        token1 = _token1;
        token2 = _token2;
        token3 = _token3;
...
contract AcuityTokenBurnTest is DSTest {
    ...
    function setUp() public {
        ...
        mixTokenBurn = new AcuityTokenBurn(mixItemStoreRegistry, mixTokenRegistry);
