...
contract AcuityTrustedAccountsTest is DSTest {
    ...
    AcuityTrustedAccountsProxy mixTrustedAccountsProxy;
    AcuityTrustedAccountsProxy mixTrustedAccountsProxy2;

    function setUp() public {
        mixTrustedAccounts = new AcuityTrustedAccounts();
        mixTrustedAccountsProxy = new AcuityTrustedAccountsProxy(mixTrustedAccounts);
        mixTrustedAccountsProxy2 = new AcuityTrustedAccountsProxy(mixTrustedAccounts);
    }
